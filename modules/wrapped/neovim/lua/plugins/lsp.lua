return {
	...
	},
	{
		...
		for_cat = "latex",
		after = function()
			-- Maps <localleader>lv to TexLab's forward search command
			vim.keymap.set("n", "<localleader>lv", "<cmd>LspTexlabForward<cr>", {
				desc = "TexLab: View PDF / Forward Search",
				silent = true,
			})
		end,
		lsp = {
			...
			settings = {
				texlab = {
					...
					chktex = {
						onOpenAndSave = true, -- Instant linting for LaTeX syntax errors
						extraArgs = { "-n11", "-n13", "-n24" },
					},
